    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-2 w-70 bg-white flex-shrink-0">
        ...
        >
          ...
          <div class="text-sm font-semibold mt-2">hi</div>
        ...
        <div class="flex flex-col mt-8">
          ...
          <div class="flex flex-col space-y-1 mt-4 -mx-2 h-100% overflow-y-auto">
            ...
            <button class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
              <div class="flex items-center justify-center h-8 w-8 bg-gray-200 rounded-full">M</div>
            ...
            <button class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
              <div class="flex items-center justify-center h-8 w-8 bg-purple-200 rounded-full">J</div>
